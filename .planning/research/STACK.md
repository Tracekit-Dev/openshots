...
**Domain:** Cross-platform desktop screenshot beautifier (Tauri 2.x + React/TypeScript)
**Researched:** 2026-04-09
**Confidence:** MEDIUM-HIGH (core stack HIGH, AI/ML layer MEDIUM)
...
# Dev dependencies
npm install -D vitest @vitest/ui vitest-canvas-mock
...
**If background removal is too slow on lower-end hardware:**
...
**If canvas complexity grows (50+ objects, real-time transforms):**
...
**If CLI batch processing needs to be standalone (no GUI):**
...
**If the app needs to ship without the RMBG model bundled:**
...
*Stack research for: Cross-platform screenshot beautifier desktop app*
*Researched: 2026-04-09*
